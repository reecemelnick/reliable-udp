...
impl FormSubmission {
    pub fn with_defaults(&self) -> FormSubmissionClean {
        FormSubmissionClean {
            ...
            client_delay_time_min: self.client_delay_time_min.parse().unwrap_or(100),
            client_delay_time_max: self.client_delay_time_max.parse().unwrap_or(200),
            server_delay_time_min: self.server_delay_time_min.parse().unwrap_or(100),
            server_delay_time_max: self.server_delay_time_max.parse().unwrap_or(200),
